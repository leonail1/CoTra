# ../scripts/sift/scala_anns_sift.sh

source ../scripts/restart_memcache.sh
CONF_FILE="../scripts/ip_w33-36.conf"
...
index_save_dir=${index_save_path}/vamana/scala_build_test_${million}M_4P
# index_save_dir=${index_save_path}/scalagraph/test_${million}M_4P
for m in 1
do
