# ../scripts/deep/vamana_anns_10M_8P.sh
# NOTE: this script is used for verification for build index after scala build. 
# merge all index in single machine and trans to b1graph, and run the search.
