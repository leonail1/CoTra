...
// RDMA verify
// #define VERIFY_BY_LOCAL

// #define DEBUG
// #define PROFILING
// #define PROF_DEGREE
// #define PROF_COMPUTATION
// #define PROF_LAZY
// #define PROF_COTRA_TP

// #define PROF_Q0Q1
// #define PRINT_CAND_DISTRIBUTION
...
class BaseSearchStopCondition {
 public:
  virtual void add_point_to_result(
      labeltype label, const void *datapoint, dist_t dist) = 0;

  virtual void remove_point_from_result(
      labeltype label, const void *datapoint, dist_t dist) = 0;

  virtual bool should_stop_search(dist_t candidate_dist, dist_t lowerBound) = 0;

  virtual bool should_consider_candidate(
      dist_t candidate_dist, dist_t lowerBound) = 0;
