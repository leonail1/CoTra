#ifndef COROGRAPH_CONTEXT_H
#define COROGRAPH_CONTEXT_H
...
#ifdef COROMEM_USE_LONGJMP_ABORT
#include <csetjmp>
#endif

#include "../galois/method_flags.h"
...
inline bool shouldLock(const galois::MethodFlag g) {
  ...
  case galois::MethodFlag::UNPROTECTED:
  case galois::MethodFlag::PREVIOUS:
    return false;
