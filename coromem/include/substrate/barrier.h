#ifndef COROGRAPH_BARRIER_H
#define COROGRAPH_BARRIER_H
...
template <typename _UNUSED = void> struct BarrierInstance {
  ...
  BarrierInstance(void) {
    ...
    m_barrier =
        createMCSBarrier(m_num_threads); // createTopoBarrier(m_num_threads);
  }
